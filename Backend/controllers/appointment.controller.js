...
export const CreateAppointment = async (req, res) => {
    try {
        ...
        const valid = appointmentValidate({ patient: verified.user._id, doctor, date, time });
        ...
        const savedAppointment = await saveAppointment({ patient: verified.user._id, doctor, date, time });
